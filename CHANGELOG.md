...
## [0.1.2] - 2025-10-11
### Changed
- Nothing, superficial release to test release pipeline
...
[Unreleased]: https://github.com/polyframe-ai/kernel/compare/v0.1.2...HEAD
[0.1.2]: https://github.com/polyframe-ai/kernel/compare/v0.1.1...v0.1.2
